            ...
            <div className="flex-1 overflow-y-auto min-h-0 w-full relative z-10" style={{ width: '100%', flex: 1, minWidth: 0, boxSizing: 'border-box', margin: 0, padding: 0 }}>
              {loading ? (
                ...
                <div className="max-w-6xl mx-auto px-6 py-8">
                  {/* Become a Mentor Button - Popup Style (only if not a mentor) */}
                  {!mentorStatus && (
                    <div className="mb-4 flex justify-end">
                      <div 
                        className="bg-[rgba(26,26,46,0.95)] backdrop-blur-[20px] border-2 border-cyan-500 rounded-xl p-4 shadow-2xl"
                        style={{
                          backdropFilter: 'blur(20px)',
                          boxShadow: glowShadow('0 0 30px rgba(6,182,212,0.5), 0 0 60px rgba(6,182,212,0.3), 0 8px 32px rgba(0,0,0,0.8)', glowIntensity)
                        }}
                      >
                        <button
                  ...
                  {/* Section 1 - AVAILABLE MENTORS (at top) */}
                  <div 
                    className="mb-6 bg-[rgba(255,255,255,0.1)] backdrop-blur-[10px] border-2 border-green-500 rounded-2xl p-6 transition-all hover:shadow-lg"
                    style={{
                    ...
                    {onlineMentors.length === 0 ? (
                      ...
                      <div className="space-y-3">
                        {onlineMentors.map(mentor => (
                          <div 
                            key={mentor.id} 
                            className="flex items-center justify-between p-4 bg-[rgba(255,255,255,0.03)] rounded-lg border border-[rgba(255,255,255,0.05)] hover:bg-[rgba(255,255,255,0.05)] transition-all"
                          >
                            <div className="flex items-center gap-3">
                              {mentor.avatar_url ? (
                                <img
                  ...
                  {/* Section 2 - YOUR MENTOR STATUS (if mentor) */}
                  {mentorStatus && (
                    <div 
                      className="mb-6 bg-[rgba(255,255,255,0.1)] backdrop-blur-[10px] border-2 border-cyan-500 rounded-2xl p-6 transition-all hover:shadow-lg"
                      style={{
                        backdropFilter: 'blur(10px)',
                    ...
                    >
                      ...
                      <div className="mb-4">
                        <label className="block text-sm font-semibold text-cyan-400 mb-2">Availability Status</label>
                        <div className="flex gap-2">
                          <button
                      ...
                      <div className="mb-4 text-sm text-[rgba(255,255,255,0.8)]">
                        <div className="mb-1">Today: <span className="font-semibold text-cyan-400">{mentorStatus.current_day_points}</span> pts</div>
                        <div className="mb-1">Week: <span className="font-semibold text-cyan-400">{mentorStatus.current_week_points}</span> pts</div>
                  ...
                  {/* Section 5 - AWAY MENTORS */}
                  {awayMentors.length > 0 && (
                    <div 
                      className="mb-6 bg-[rgba(255,255,255,0.1)] backdrop-blur-[10px] border-2 border-yellow-500 rounded-2xl p-6 transition-all hover:shadow-lg"
                      style={{
                        backdropFilter: 'blur(10px)',
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        {(leaderboardTab === 'today' ? leaderboard.today :
                          ...
                          <div 
                            key={entry.id} 
                            className="flex items-center justify-between p-3 bg-[rgba(255,255,255,0.03)] rounded-lg border border-[rgba(255,255,255,0.05)] hover:bg-[rgba(255,255,255,0.05)] transition-all"
                          >
                            <div className="flex items-center gap-3">
