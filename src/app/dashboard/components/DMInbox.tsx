...
export function DMInbox({ currentUserId, forceOpen }: { currentUserId: string; forceOpen?: boolean }) {
  ...
  return (
    <div className="relative" ref={dropdownRef} style={{ zIndex: 999999 }}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="fixed w-80 bg-[rgba(26,26,46,0.95)] backdrop-blur-[20px] rounded-xl border border-[rgba(255,255,255,0.2)] overflow-hidden" style={{ right: '1rem', top: '4rem', backdropFilter: 'blur(20px)', boxShadow: '0 0 40px rgba(6,182,212,0.3), 0 8px 32px rgba(0,0,0,0.8)', zIndex: 999999 }}>
          {/* Header */}
